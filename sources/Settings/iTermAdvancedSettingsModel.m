...
DEFINE_BOOL(anchorVerticalTabsAtBottom, NO, SECTION_TABS @"Anchor tabs to the bottom of vertical tab bars?\nWhen on, the tabs stack up from the bottom edge of a left or right tab bar and the empty space is above them. If more tabs are open than fit, the bar stays scrolled to the bottom until you scroll up.");
